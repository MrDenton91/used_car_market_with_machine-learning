...
def populate_car_list(zip,page_num):
    with open('./carlist13.csv','a') as f:
...
## but I'm expected a 98% duplication, leaving me 3.2 million cars maybe... probally a lot less give the size of this website...
